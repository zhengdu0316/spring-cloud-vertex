package org.vertex.channel.config.handler;
...
import org.vertex.common.exception.BizException;
...
@Slf4j
@ControllerAdvice
public class OtherGlobalExceptionHandler {
    ...
    public static ResultBean<Object> doGlobalExceptionHandler(Throwable e) {
        ...
        if (e instanceof BizException) {
            ...
            return ResultBean.ofError(StringUtils.isEmpty(errorMsg) ? "未知错误" : errorMsg);
        }
    }
